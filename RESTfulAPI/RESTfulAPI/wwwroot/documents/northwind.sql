...
-- -----------------------------------------------------
-- Table `northwind`.`useraccounts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind`.`useraccounts` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `username` VARCHAR(256) NULL DEFAULT NULL,
  `normalized_username` VARCHAR(50) NULL DEFAULT NULL,
  `email_address` VARCHAR(50) NULL DEFAULT NULL,
  `normalized_email_address` VARCHAR(50) NULL DEFAULT NULL,
  `email_confirmed` BIT NULL DEFAULT NULL,
  `password_hash` VARCHAR(255) NULL DEFAULT NULL,
  `security_stamp` VARCHAR(255) NULL DEFAULT NULL,
   PRIMARY KEY (`id`))
ENGINE = InnoDB
