...
namespace RESTfulAPI.Controllers
{
    ...
    public class PurchaseOrderController : Controller
    {
        ...
        public PurchaseOrderController(IRESTfulAPI_Repository repository, IOptions<DatabaseSettings> databaseSettings, IHostingEnvironment hostingEnvironment, IOptions<LinuxSettings> linuxSettings)
        {
        ...
        public async Task<IActionResult> GetPurchaseOrdersAsync(Int32? pageSize = 10, Int32? pageNumber = 1, String name = null)
        {
            var response = new ListModelResponse<PurchaseOrderViewModel>() as IListModelResponse<PurchaseOrderViewModel>;
            ...
            try
            {
                ...
                response.Model = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository
                        .GetPurchaseOrders(response.PageSize, response.PageNumber, name)
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> GetPurchaseOrderAsync(Int32 id)
        {
            var response = new SingleModelResponse<PurchaseOrderViewModel>() as ISingleModelResponse<PurchaseOrderViewModel>;

            try
            {
                response.Model = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.GetPurchaseOrder(id).ToViewModel();
                });
            }
            catch (Exception ex)
            {
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> CreatePurchaseOrderAsync([FromBody]PurchaseOrderViewModel value)
        {
            ...
            try
            {
                ...
                {
                    return _RESTfulAPI_Repository.AddPurchaseOrder(value.ToEntity());
                });
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> UpdatePurchaseOrderAsync(Int32 id, [FromBody]PurchaseOrderViewModel value)
        {
            var response = new SingleModelResponse<PurchaseOrderViewModel>() as ISingleModelResponse<PurchaseOrderViewModel>;
            ...
            try
            {
                var entity = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.UpdatePurchaseOrder(id, value.ToEntity());
                });
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> DeletePurchaseOrderAsync(Int32 id)
        {
            var response = new SingleModelResponse<PurchaseOrderViewModel>() as ISingleModelResponse<PurchaseOrderViewModel>;
            ...
            try
            {
                var entity = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.DeletePurchaseOrder(id);
                });
