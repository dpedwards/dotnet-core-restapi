...
namespace RESTfulAPI.Controllers
{
    ...
    public class OrderDetailStatusController : Controller
    {
        ...
        public OrderDetailStatusController(IRESTfulAPI_Repository repository, IOptions<DatabaseSettings> databaseSettings, IHostingEnvironment hostingEnvironment, IOptions<LinuxSettings> linuxSettings)
        {
        ...
        public async Task<IActionResult> GetOrderDetailStatussAsync(Int32? pageSize = 10, Int32? pageNumber = 1, String name = null)
        {
            var response = new ListModelResponse<OrderDetailStatusViewModel>() as IListModelResponse<OrderDetailStatusViewModel>;
            ...
            try
            {
                ...
                response.Model = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository
                        .GetOrderDetailStatuses(response.PageSize, response.PageNumber, name)
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> GetOrderDetailStatusAsync(Int32 id)
        {
            var response = new SingleModelResponse<OrderDetailStatusViewModel>() as ISingleModelResponse<OrderDetailStatusViewModel>;

            try
            {
                response.Model = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.GetOrderDetailStatus(id).ToViewModel();
                });
            }
            catch (Exception ex)
            {
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> CreateOrderDetailStatusAsync([FromBody]OrderDetailStatusViewModel value)
        {
            ...
            try
            {
                ...
                {
                    return _RESTfulAPI_Repository.AddOrderDetailStatus(value.ToEntity());
                });
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> UpdateOrderDetailStatusAsync(Int32 id, [FromBody]OrderDetailStatusViewModel value)
        {
            var response = new SingleModelResponse<OrderDetailStatusViewModel>() as ISingleModelResponse<OrderDetailStatusViewModel>;
            ...
            try
            {
                var entity = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.UpdateOrderDetailStatus(id, value.ToEntity());
                });
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> DeleteOrderDetailStatusAsync(Int32 id)
        {
            var response = new SingleModelResponse<OrderDetailStatusViewModel>() as ISingleModelResponse<OrderDetailStatusViewModel>;
            ...
            try
            {
                var entity = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.DeleteOrderDetailStatus(id);
                });
