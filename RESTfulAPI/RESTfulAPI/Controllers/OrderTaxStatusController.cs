...
namespace RESTfulAPI.Controllers
{
    ...
    public class OrderTaxStatusController : Controller
    {
        ...
        public OrderTaxStatusController(IRESTfulAPI_Repository repository, IOptions<DatabaseSettings> databaseSettings, IHostingEnvironment hostingEnvironment, IOptions<LinuxSettings> linuxSettings)
        {
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> GetOrderTaxStatusAsync(Int32 id)
        {
            var response = new SingleModelResponse<OrderTaxStatusViewModel>() as ISingleModelResponse<OrderTaxStatusViewModel>;

            try
            {
                response.Model = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.GetOrderTaxStatus(id).ToViewModel();
                });
            }
            catch (Exception ex)
            {
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> CreateOrderTaxStatusAsync([FromBody]OrderTaxStatusViewModel value)
        {
            ...
            try
            {
                ...
                {
                    return _RESTfulAPI_Repository.AddOrderTaxStatus(value.ToEntity());
                });
        ...
        [ApiExplorerSettings(IgnoreApi = false)]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateOrderTaxStatusAsync(Int32 id, [FromBody]OrderTaxStatusViewModel value)
        {
            var response = new SingleModelResponse<OrderTaxStatusViewModel>() as ISingleModelResponse<OrderTaxStatusViewModel>;
            ...
            try
            {
                var entity = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.UpdateOrderTaxStatus(id, value.ToEntity());
                });
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        [ApiExplorerSettings(IgnoreApi = false)]
        public async Task<IActionResult> DeleteOrderTaxStatusAsync(Int32 id)
        {
            var response = new SingleModelResponse<OrderTaxStatusViewModel>() as ISingleModelResponse<OrderTaxStatusViewModel>;
            ...
            try
            {
                var entity = await Task.Run(() =>
                {
                    return _RESTfulAPI_Repository.DeleteOrderTaxStatus(id);
                });
